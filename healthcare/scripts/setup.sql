...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.ENCOUNTERS
SELECT 2141, 35, 2, 8, 'Inpatient', DATEADD(DAY, -80, CURRENT_DATE()), DATEADD(DAY, -76, CURRENT_DATE()), 4, 'UTI', 'Completed'
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.ENCOUNTERS
SELECT 2341, 16, 8, 8, 'Outpatient', DATEADD(DAY, -67, CURRENT_DATE()), DATEADD(DAY, -67, CURRENT_DATE()), 0, 'Cellulitis', 'Completed'
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.ENCOUNTERS
SELECT 2541, 17, 7, 8, 'Inpatient', DATEADD(DAY, -51, CURRENT_DATE()), DATEADD(DAY, -48, CURRENT_DATE()), 3, 'Hypertension crisis', 'Completed'
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.ENCOUNTERS
SELECT 2741, 16, 21, 2, 'Inpatient', DATEADD(DAY, -37, CURRENT_DATE()), DATEADD(DAY, -36, CURRENT_DATE()), 1, 'Post-surgical monitoring', 'Completed'
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.ENCOUNTERS
SELECT 2941, 13, 4, 4, 'Outpatient', DATEADD(DAY, -23, CURRENT_DATE()), DATEADD(DAY, -23, CURRENT_DATE()), 0, 'Ankle fracture', 'Completed'
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.ENCOUNTERS
SELECT 3141, 17, 12, 6, 'Inpatient', DATEADD(DAY, -8, CURRENT_DATE()), DATEADD(DAY, -2, CURRENT_DATE()), 6, 'Leukemia', 'Completed'
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.DAILY_CENSUS
SELECT 201, 3, DATEADD(DAY, -69, CURRENT_DATE()), 9, 9, 84, 100
...
INSERT INTO HEALTHCARE_HOL_DB.CLINICAL.DAILY_CENSUS
SELECT 401, 5, DATEADD(DAY, -49, CURRENT_DATE()), 4, 3, 34, 40
