...
```
Each track's LAB_GUIDE covers Steps 0-5
┌──────────────────────────────────────┐
│ 0. Login + Cortex Code + GitHub      │
│ 1. Build Database                    │
│ 2. Create Semantic Layer             │
│ 3. Set Up Document Search            │
│ 4. Build Intelligence Agent          │
...
│
├── healthcare/
│   ├── LAB_GUIDE.md                   (Steps 0-5 for Healthcare)
